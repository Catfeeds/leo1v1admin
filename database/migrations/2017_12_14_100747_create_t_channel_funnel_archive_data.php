...
class CreateTChannelFunnelArchiveData extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('t_channel_funnel_archive_data', function (Blueprint $table) {
    ...
    {
        Schema::drop('t_channel_funnel_archive_data');
    }
}
