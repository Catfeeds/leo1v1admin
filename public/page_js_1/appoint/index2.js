	        ...
	        buttons: [{
		        ...
		        action: function(dialog) {
                    ...
                    $.getJSON('/appoint/set_package_simple_info', {
                        'packageid': packageid, 'package_name': package_name,
                        'package_intro': package_intro, 'suit_student': suit_student,
                        'subject': subject, 'lesson_total': lesson_total,'grade': grade,
                        'package_tags': package_tags, 'package_target':package_target
                    }, function(result){
                        BootstrapDialog.alert(result['info']);
                    });
