$(function(){
    ...
    function load_data(){
        ...
        var url = "/tea_manage/open_class2/?teacherid="+teacherid+"&lesson_status="+lesson_status+"&lesson_type="+lesson_type+"&start="+start+"&end="+end;
    ...
    admin_select_user($("#id_search_teacher"),"teacher",
            function(){
                load_data();
        });
    ...
    $("#id_add_lesson").on("click", function(){
        ...
        var on_change_lesson=function(value ,row_data ,dialog){
        ...
        var on_change_course = function( value ,row_data ,dialog) {
