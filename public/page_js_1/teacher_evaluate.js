...
$(function(){
	...
	$('#datetimepicker13').datetimepicker({
	    ...
	    onChangeDateTime :function(){
	        ...
	        var start_time = $("#datetimepicker13").val();
		    var end_time = $("#datetimepicker14").val();
		    var is_part_time = $("#id_is_part_time").val();
		    load_data( tea_nick,is_part_time,start_time,end_time);
        }
	});
	...
	//时间控件-over
	function load_data( $tea_nick,$is_part_time,$start_time,$end_time){
	 var url="/tea_manage/teacher_evaluation?tea_nick="+$tea_nick+"&is_part_time="+$is_part_time+"&start_time="+$start_time+"&end_time="+$end_time;
	 window.location.href=url;
	}

    
	$(".eva_change").on("change",function(){
		var start_time = $("#datetimepicker13").val();
		var end_time = $("#datetimepicker14").val();
		var tea_nick = $("#id_tea_name").val();
		var is_part_time = $("#id_is_part_time").val();
