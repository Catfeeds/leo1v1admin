...
function ka(az) {
    ...
    if (!ismobile) d.style.overflow = "hidden";
};
function kN() {
...
document.onkeyup = function(e) {
    ...
    case 38:
        ...
        if (aJ.ak >= 0) {
            ...
            K = document.getElementById("s" + aJ.ak);
            K.style.display = "";
        }
        break;
    case 34:
...
function lQ(rl, i, bw, ef) {
    ...
    if (b.eff < 54 && b.eff != 11) {
        if (b.o.firstElementChild) b.o.style.visibility = (b.exit ? "hidden": "");
        aj.Opacity(b.o, 1);
    }
    ni(b);
    if (b.o.style.visibility == "hidden") {
            ...
            if (a.trigger != last) {
                ...
                tt.bu = function() {
                    ...
                    while (this.ak < this.au.length && this.au[this.ak].type != 0) {
                        ...
                        if (c.aA) {
                            for (var i = 0, ai = c.aA.length; i < ai; i++) {
                                var d = c.aA[i];
                ...
                tt.dI = function(b) {
                    ...
                    page = page.substr(1);
                    syncPageAnim(page, anim, trigger, false);
                    if (iscef) {
                        var now = (new Date().getTime()) - starttm;
                        dU += "a_" + now + "_" + iS + ";";
                    }
                ...
                tt.gO = function() {
                    ...
                    var anim = this.ak;
                    page = page.substr(1);
                    syncPageAnim(page, anim, this.trigger, true);
                };
                tt.dG = function() {
                    var now = (new Date().getTime()) - starttm;
...
function eP(o, a) {
    ...
    for (var v = 0; v < src.length; v++) {
        var srcnode = src[v];
        if (srcnode.children[0] && srcnode.children[0].className == "vchar") {
            srcnode = srcnode.children[0];
        }
        for (var F = 0,
        gH = srcnode.children.length; F < gH; F++) {
            var T = "";
            var child = srcnode.children[F];
            ...
            child.innerHTML = T;
            srcnode.children[F].style.width = "1em";
        }
    }
};
function hk(o, a) {
...
function fl(aY) {
    ...
    if (!iscef) {
        ...
        if (bP != -10000) {
            if (bP >= 0) {
                if (ismobile && autoplay > 0) menu_move(bP - aJ.ak);
                else bE(bP);
            }
            return;
        }
...
window.onload = function() {
	...
	if(window.thum){
	    ...
	    arrows.innerHTML = "<div class='leftarrow'><img id='butl' src='../left.png' onmouseup='onMenu1(0)'/></div><div class='rightarrow'><img id='butr' src='../right.png' onmouseup='onMenu1(1)'/></div>";
...
iw(function() {
    try {
        var rec = iH("rec");
        if (typeof(cefsharp) != 'undefined' && rec == 1) {
            iscef = 1;
            cefsharp.init();
            cefaudio.init();
        }
...
function JudgeAgent() {
    ...
    var mk = sUserAgent.match(/ipad/i) == "ipad";
    var nu = sUserAgent.match(/iphone os/i) == "iphone os";
    var oS = sUserAgent.match(/android/i) == "android";
    var nD = sUserAgent.match(/MicroMessenger/i) == "micromessenger";
    var pq = sUserAgent.match(/windows mobile/i) == "windows mobile";
    isEdge = sUserAgent.toLowerCase().indexOf("edge") > 0;
    mz = mk || nu;
    ismobile = mz || oS;
};
var xmlHttpRequest;
...
function jw(ge) {
    ...
    autoplay = parseInt(json.wtoption) & 0x04;
    ot = parseInt(json.wtoption) & 0x02;
...
function jV() {
    ...
    if (iscef == 1 || (window.optjson && window.optjson.wtoption & 0x4) > 0) {
        AddAutoPlayButton();
    }
    inneriFrame_init();
...
function bE(bP) {
    ...
    if (a) {
        ...
        a.play();
        aG = a;
    } else if (window._control[bP].ends == 1) {
        bN();
    }
    if (window._control[bP].trans != null && bz != bO) {
        bO.style.left = "0px";
        bO.style.top = "0px";
        ...
        while (tt.ak < fM) {
            ...
            if (c.aA) {
                ...
                if (c.bp) {
                    ...
                    c.o.style.visibility = (c.exit || (c.after > 1) ? "hidden": "");
                }
            }
            tt.ak++;
        }
