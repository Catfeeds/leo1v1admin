...
$(function(){
    ...
    $(".opt-share").on("click",function(){
        ...
        $.do_ajax("/teacher_info_admin/get_share_link",{
            "teacherid"  :g_args.teacherid,
            "share_path" : opt_data.abs_path,
        },function(resp){
            $.wopen("/teacher_share?sign=" +encodeURIComponent(resp.sign)   );
    ...
    $(".opt-download").on("click",function(){
        var opt_data=$(this).get_opt_data();
        $.do_ajax("/teacher_info_admin/get_download_url",{
    ...
    $("#id_add_dir").on("click",function(){
        ...
        $.show_key_value_table("新建文件夹",$arr, {
            ...
            action: function(dialog) {
                $.do_ajax("/teacher_info_admin/file_store_add_dir",{
                    "teacherid" : g_args.teacherid,
                    "dir" :  g_args.dir,
    ...
    var custom_upload = function(btn_id, containerid, domain, compelete_func){
        ...
        $.do_ajax("/teacher_info_admin/get_upload_token",{
            "dir" : g_args.dir,
            "teacherid" :g_args.teacherid
        },function(resp){
