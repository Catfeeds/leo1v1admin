...
tofile: 
	 mkdir -p ../assistant_performance; vi  ../assistant_performance/get_ass_self_order_info.ts

/// <reference path="../common.d.ts" />
/// <reference path="../g_args.d.ts/assistant_performance-get_ass_self_order_info.d.ts" />
