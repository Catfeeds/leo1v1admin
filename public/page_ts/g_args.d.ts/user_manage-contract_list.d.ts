...
{!!\App\Helper\Utils::th_order_gen([["adminid title", "adminid", "th_adminid" ]])!!}
        ...
        <div class="col-xs-6 col-md-2">
            <div class="input-group ">
                <span class="input-group-addon">is_origin</span>
                <input class="opt-change form-control" id="id_is_origin" />
            </div>
        </div>
{!!\App\Helper\Utils::th_order_gen([["is_origin title", "is_origin", "th_is_origin" ]])!!}
