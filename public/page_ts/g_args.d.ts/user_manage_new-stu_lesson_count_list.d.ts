...
{!!\App\Helper\Utils::th_order_gen([["end_time title", "end_time", "th_end_time" ]])!!}
        ...
        <div class="col-xs-6 col-md-2">
            <div class="input-group ">
                <span class="input-group-addon">page_number</span>
                <input class="opt-change form-control" id="id_page_number" />
            </div>
        </div>
{!!\App\Helper\Utils::th_order_gen([["page_number title", "page_number", "th_page_number" ]])!!}
