...
tofile: 
	 mkdir -p ../seller_student_new2; vi  ../seller_student_new2/seller_get_new_count_admin_list_new.ts

/// <reference path="../common.d.ts" />
/// <reference path="../g_args.d.ts/seller_student_new2-seller_get_new_count_admin_list_new.d.ts" />
