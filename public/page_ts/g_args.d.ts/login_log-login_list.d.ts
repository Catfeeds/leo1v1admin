interface GargsStatic {
	...
	end_time:	string;
	account:	string;
	all_account:	number;//枚举: \App\Enums\Eboolean
}
...
tofile: 
	 mkdir -p ../login_log; vi  ../login_log/login_list.ts
...
$(function(){
	...
	$('#id_all_account').admin_set_select_field({
		"enum_type"    : "boolean",
		"field_name" : "all_account",
		"select_value" : g_args.all_account,
		"onChange"     : load_data,
		"multi_select_flag"     : false ,
		"th_input_id"  : "th_all_account",
...
{!!\App\Helper\Utils::th_order_gen([["all_account title", "all_account", "th_all_account" ]])!!}
*/
