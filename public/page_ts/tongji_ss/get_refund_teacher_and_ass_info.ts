...
$(function(){
    ...
    $(".tea_num").on("click",function(){
        ...
        //alert(teacherid);
        var title = "老师退费投诉详情";
        var html_node= $("<div  id=\"div_table\"><table   class=\"table table-bordered \"><tr><td>合同id</td><td>老师</td><td>学生</td><td>退费时间</td><tr></table></div>");
        ...
        $.do_ajax('/ss_deal2/get_refund_teacher_detail_info',{
            ...
            $.each(userid_list,function(i,item){
                html_node.find("table").append("<tr><td>"+item['orderid']+"</td><td>"+item["teac_nick"]+"</td><td>"+item["stu_nick"]+"</td><td>"+item["apply_time"]+"</td></tr>");
            });
