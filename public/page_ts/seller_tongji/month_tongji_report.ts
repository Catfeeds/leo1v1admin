...
$(function(){
    ...
    function superAdd(className,nextName){
        $("#id_tbody ."+className).each(function(){
            ...
            var dis_succ_all_count_for_month = 0;
            ...
            $(this).find('.dis_succ_all_count_for_month').text(dis_succ_all_count_for_month);
    ...
    function successAndFail(){
        $('#id_tbody tr[class!="l-5"]').each(function(){
            ...
            if(success_count != 0 && dis_succ_count != 0){
                // var order_per = (success_count/succ_count)*10000;
                var order_per = (success_count/dis_succ_count)*10000;
