...
$(function(){
    ...
    $(".opt-reset-stu").on("click",function(){
        //alert("开发中");
        BootstrapDialog.confirm(
            "确认?",
            function(val) {
    ...
    $(".opt-reset-revisit").on("click",function(){
        //alert("开发中");
        BootstrapDialog.confirm(
            "确认?",
            function(val) {
    ...
    $(".opt-reset-kk").on("click",function(){
        //alert("开发中");
        BootstrapDialog.confirm(
            "确认?",
            function(val) {
    ...
    $(".opt-reset-order").on("click",function(){
        //alert("开发中");
        BootstrapDialog.confirm(
            "确认?",
            function(val) {
    ...
    $(".opt-reset-lesson").on("click",function(){
        //alert("开发中");
        BootstrapDialog.confirm(
            "确认?",
            function(val) {
