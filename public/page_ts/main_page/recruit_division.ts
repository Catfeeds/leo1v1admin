$(function(){
    ...
    $('#id_date_range').select_date_range({
        ...
        'history_data'  : g_args.history_data,
    ...
    $('#download_data').on("click", function(){
        var list_data = [
            ["科目",'面试通过人数','模拟试听总排课率','模拟试听总排课人数','模拟试听总上课率','模拟试听总上课人数','模拟试听总通过率','模拟试听总通过人数','入职总人数'],
        ];
        ...
        list_data.push(["老师类型",'面试通过人数','模拟试听总排课率','模拟试听总排课人数','模拟试听总上课率','模拟试听总上课人数','模拟试听总通过率','模拟试听总通过人数','入职总人数']);
