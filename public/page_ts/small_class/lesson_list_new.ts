...
/// <reference path="../g_args.d.ts/small_class-lesson_list_new.d.ts" />
$(function(){
    function load_data(){
        $.reload_self_page ( {
    ...
    var goto_student_list= function ( lessonid ){
        if ( window.location.pathname =="/small_class/lesson_list_new" ) {
            window.location.href='/small_class/student_list_new?courseid='+g_args.courseid+"&studentid=-1&lessonid="+lessonid+"&return_url="+ encodeURIComponent(window.location.href);
        }else{
            window.location.href='/small_class/student_list_new_ass?courseid='+g_args.courseid+"&studentid=-1&lessonid="+lessonid+"&return_url="+ encodeURIComponent(window.location.href);
        }	 
    };
