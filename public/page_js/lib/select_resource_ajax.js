(function($, window, document,undefined) {
    ...
    var Cselect_dlg_ajax = function(ele, opt) {
        ...
        this.defaults = {
            ...
            "url"      : "/teacher_info/get_resource_js",
            "lru_flag" : false,
            "th_input_id" :null,
    ...
    Cselect_dlg_ajax.prototype = {
        init_body:function() {
            ...
            $.each(me.options.filter_list,function (i,row_item){
                var $filter_row= $('<div class="row my-mark"></div>');
            ...
            $.ajax({
                ...
                success  : function(result){
                    ...
                    $.each( ret_list, function(i,item){
                        var $tr_item=$("<tr class=\"tr_mark\" data-id="+item.tea_res_id+" data-link="+item.file_link+"/>");
    ...
    //在插件中使用对象
    $.fn.tea_select_res_ajax = function(options) {
