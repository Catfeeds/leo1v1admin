(function($, window, document,undefined) {
    ...
    Cselect_dlg.prototype = {
        ...
        ,show_select:function(){
            ...
            $.each( me.options.data_list,function(i,row_item){
                ...
                if(me.options.forbid_arr.length > 0 && $.inArray(row_item[0],me.options.forbid_arr) !== -1){
                    class_str += " forbid_choose"; 
                }
            ...
            $tbody.find("tr").on("click",function(){
                if($(this).hasClass("forbid_choose")){
                    alert(me.options.forbid_title);
                    return false;
                }
    ...
    //在插件中使用对象
    $.fn.admin_select_dlg_forbid = function(options) {
        //创建的实体
