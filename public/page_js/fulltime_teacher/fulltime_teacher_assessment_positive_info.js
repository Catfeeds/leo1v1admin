        ...
        if(id <= 0){
           // BootstrapDialog.alert("该老师还未进行考核自评!");
            ...
            $.do_ajax( "/fulltime_teacher/get_fulltime_teacher_assessment_info_by_adminid",{
                ...
                var html_score=
                    "<tr>"
                    +"<td>试用期转化率:"+list.order_per+"%</td>"
                    +"<td>"+list.order_per_score+"</td>"
                    +"</tr>"
                    +"<tr>"
                    +"<td>当前常规学生数:"+list.stu_num+"</td>"
                    +"<td>"+list.stu_num_score+"</td>"
                    +"</tr>"
                    +"<tr>"
                    +"<td>家长评价:"+list.lesson_level+"星</td>"
                    +"<td>"+list.lesson_level_score+"</td>"
                    +"</tr>"
                    +"<tr>"
                    +"<td>目前常规学生周课时数:"+list.stu_lesson_total+"</td>"
                    +"<td>"+list.stu_lesson_total_score+"</td>"
                    +"</tr>"
                ;                                            
