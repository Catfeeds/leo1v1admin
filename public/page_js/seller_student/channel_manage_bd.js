$(function(){
  ...
  function load_data(){
    ...
    $("#id_key1,#id_value,#id_origin_level").on("change",function(){
        load_data ();
    });
    ...
    $("#id_add_new").on("click",function(){
      // 处理
        ...
        // console.log($key1_s);
        Enum_map.append_option_list("origin_level",origin_level ,true,[1,2,3] );
        ...
        var set_select=  function ( $select, key1,key2,key3) {
            do_ajax("/user_deal/origin_get_key_list_bd", {
                "key1" : key1,
                "key2" : key2,
                "key3" : key3
            },function(ret){
        ...
        var set_select_key1=  function ( $select, key1,key2,key3) {
            do_ajax("/user_deal/origin_get_key_list_bd", {
                "key1" : key1,
                "key2" : key2,
                "key3" : key3
