...
/*
tofile:
	 mkdir -p ../admin_manage; vi  ../admin_manage/get_flow_branch_switch_value.ts

import Vue from 'vue'
import Component from 'vue-class-component'
import vtable from "../../components/vtable"
import {self_RowData, self_Args } from "../page.d.ts/admin_manage-get_flow_branch_switch_value"
// @Component 修饰符注明了此类为一个 Vue 组件.
@Component({
  // 所有的组件选项都可以放在这里.
  template:  require("./get_flow_branch_switch_value.html" ),
})
export default class extends vtable {
  ...
  query_init( $header_query_info): void{
	...
	$.admin_query_input({
		...
		"field_name"    : "flow_function" ,
		"placeholder" : "回车查询", 
		"length_css" : "col-xs-12 col-md-3", 
		"title"        :  "flow_function",
		"select_value" : this.get_args().flow_function,
	});
