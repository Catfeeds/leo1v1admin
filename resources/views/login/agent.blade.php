...
<html class="bg-blue">
    ...
    <body>
                ...
                <div class="col-md-3 col-md-offset-7 col-xs-8 col-xs-offset-2">
                    <div class="login">
                        ...
                        <div class="bor-btm-3 login-mid">
                            ...
                            <input class="bor-no bl-right" type="text"  id="id_phone" placeholder="请输入手机账号">
                        </div>
                        <div class="bor-btm-3 login-mid">
        ...
        <script type="text/javascript" src="/page_ts/login/agent.js?{{$_publish_version}}"></script>
        <!-- Bootstrap -->
