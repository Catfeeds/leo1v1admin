...
@section('content')
    ...
    <section class="content">
        <div id="id_question_editor" >
            ...
            <div class="row">
                <div class="col-xs-6 col-md-6">
                    <textarea type="text" value="" class="form-control math-opt-change-q " style="height:480px;font-size:18px;" id="id_mathjax_content" placeholder=""></textarea>
                ...
                <div class="col-xs-6 col-md-6  ">
                    <div id="MathPreview" style="border: 1px solid; width: 100%; height: 480px; overflow: auto; font-size: 18px;">
                    </div>    
                </div>
            </div>
        </div>
