                        ...
                        @foreach ($table_data_list as $var)
                            <tr class="{{$var["level"]}}">
                                ...
                                @if($origin_type)
                                    ...
                                    <td >{{intval(@$var["avg_first_time"]/60)}}</td>
                                    <td ><a target="_blank" href="http://admin.yb1v1.com/agent/agent_list_new?type=5&start_time={{@$start_time}}&end_time={{@$end_time}}">{{@$var["tq_no_call_count"]}}</a></td>
                                    <td ><a target="_blank" href="http://admin.yb1v1.com/agent/agent_list_new?type=6&start_time={{@$start_time}}&end_time={{@$end_time}}">{{@$var["tq_called_count"]}}</a></td>

                                    <td ><a target="_blank" href="http://admin.yb1v1.com/agent/agent_list_new?type=7&start_time={{@$start_time}}&end_time={{@$end_time}}">{{@$var["tq_call_fail_count"]}}</a></td>
                                    ...
                                    <td><a target="_blank" href="http://admin.yb1v1.com/agent/agent_list_new?type=14&start_time={{@$start_time}}&end_time={{@$end_time}}">{{@$var["require_count"]}}</a></td>
                                    <td><a target="_blank" href="http://admin.yb1v1.com/agent/agent_list_new?type=15&start_time={{@$start_time}}&end_time={{@$end_time}}">{{@$var["test_lesson_count"]}}</a></td>
                                    <td><a target="_blank" href="http://admin.yb1v1.com/agent/agent_list_new?type=16&start_time={{@$start_time}}&end_time={{@$end_time}}">{{@$var["succ_test_lesson_count"]}}</a></td>
                                    <td class="text-danger"></td>
                                    <td class="text-danger"></td>
                                    <td><a target="_blank" href="http://admin.yb1v1.com/agent/agent_order_list?start_time={{@$start_time}}&end_time={{@$end_time}}">{{@$var["order_count"]}}</a></td>
                                    <td><a target="_blank" href="http://admin.yb1v1.com/agent/agent_order_list?start_time={{@$start_time}}&end_time={{@$end_time}}">{{@$var["user_count"]}}</a></td>
                                    <td><a target="_blank" href="http://admin.yb1v1.com/agent/agent_order_list?start_time={{@$start_time}}&end_time={{@$end_time}}">{{@$var["order_all_money"]}}</a></td>
                                @else
                                    <td >{{@$var["all_count"]}}</td>
                                    <td >{{@$var["assigned_count"]}}</td>
                                    <td >{{@$var["tmk_assigned_count"]}}</td>
