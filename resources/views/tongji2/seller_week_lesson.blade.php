                    ...
                    @foreach ($table_data_list as $var)
                        ...
                        @for( $i=0;$i<7;$i++ )
                            <td>
                                ...
                                {{@$var["v_".$i."_require_lesson_count"] }}/
                                {{@$var["v_".$i."_all_lesson_count"] }} /
                                @if(@$var["v_".$i."_need_lesson_count"] > 5)
                                    <font color="red" >
                                        {{@$var["v_".$i."_need_lesson_count"] }}
                                    </font>
                                @else
                                    {{@$var["v_".$i."_need_lesson_count"] }}
                                @endif
                        ...
                        <td>
                            <font color="red" >
                                ...
                                {{@$var["v_week_require_lesson_count"] }}/
                                {{@$var["v_week_all_lesson_count"] }}/
                                {{@$var["v_week_need_lesson_count"] }}
                            </font>
                        </td>
