              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="/AdminLTE-2.4.0-rc/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="/AdminLTE-2.4.0-rc/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li ><a href="index2.html"><i class="fa fa-circle-o"></i> <span> 课程列表 </span> </a></li>
        <li class="active" ><a href="index2.html"><i class="fa fa-circle-o"></i> <span> 当前课表 </span> </a></li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li ><a href="index.html"><i class="fa fa-circle-o"></i>基本属性 </a></li>
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src="/AdminLTE-2.4.0-rc/dist/img/user4-128x128.jpg" alt="user image" class="online">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="/AdminLTE-2.4.0-rc/dist/img/user3-128x128.jpg" alt="user image" class="offline">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="/AdminLTE-2.4.0-rc/dist/img/user2-160x160.jpg" alt="user image" class="offline">
...
<script src="/AdminLTE-2.4.0-rc/dist/js/pages/dashboard.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="/page_ts/teacher_info/test.js"></script>
</body>
</html>
