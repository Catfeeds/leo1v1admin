                                ...
                                @foreach ( $table_data_list as $var )
                                    @if($var['index'] == 1)
                                        <tr>
                                            <td colspan="4">
                                                <div class="row">
                                                    <div class="col-xs-4" style="background-image:url({{$var["face_pic"]}}) no-repeat; background-size: 100% 100%; height: 100px;">
                                                        <a title="" class=" fa-trophy fa" style="color:#F6A623;"></a><br>
                                                        {{$var["sys_operator"]}}<br>
                                                        {{$var["all_count"]}} <br>
                                                        {{$var["all_price"]}}
                                                    </div>
