                            ...
                            <tbody id="id_group_body">
                                @foreach ( $group_list as $key=> $var )
                                    <tr>
                                        ...
                                        <td class="all_price">
                                            @if($key==0)
                                                <font style="color:#F6A623;">{{$var["all_price"]/$var["month_money"]}}</font>
                                            @elseif($key==1)
                                                <font style="color:#9EB0C2;">{{$var["all_price"]/$var["month_money"]}}</font>
                                            @elseif($key==2)
                                                <font style="color:#CB7F31;">{{$var["all_price"]/$var["month_money"]}}</font>
                                            @else
                                                {{$var["all_price"]/$var["month_money"]}}
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
