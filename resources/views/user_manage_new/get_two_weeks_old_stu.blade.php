...
<section class="content " >
    <div class="row row-query-list">
        ...
        <div  class="col-xs-6 col-md-4">
            <div class="input-group ">
                <span class="input-group-addon">助教分组</span>
        ...
        <table   class=" common-table "    >
            <thead>
                <tr>
                    ...
                    <td style="width:50px;" >注册时间</td>
                    <td style="width:50px;" >结课时间</td>
                    <td >赞</td>
                    <td style="display:none;" >是否是测试学员</td>
                    <td style="display:none;" >学员渠道</td>
                    <td style="display:none;" >渠道(2)</td>
                    <!-- <td  class="remove-for-xs"  style="width:160px;display:none;"  >版本信息</td> -->
            ...
            <tbody>
                @foreach ($table_data_list as $var)
                    <tr>
                        ...
                        <td >{{$var["originid"]}}</td>
                        <td >{{$var["origin"]}}</td>
                        <!-- <td style="display:none;" >{{$var["user_agent_simple"]}}</td> -->
