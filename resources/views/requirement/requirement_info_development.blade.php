            ...
            <tbody>
                @foreach ( $table_data_list as $var )
                    <tr>
                        ...
                        @if ($var['status'] == 4 && $var['test_status'] == 1)
                        ...
                        <td>
                            ...
                            >
                                @if (@$var['development_status'] == 0)
                                    <a class="fa  opt-deal"  title="处理">处理</a>
                                    <a class="fa  opt-reject"  title="驳回">驳回</a>
                                @endif
                                @if ($var['test_status'] == 1)
                                <a class="fa  opt-re-deal"  title="重新提交">重新提交</a>
                                @endif
                                @if (@$var['development_status'] == 2)
                                    <a class="fa  opt-do"  title="开发">开发</a>
                                @endif
                                @if (@$var['development_status'] == 3)
                                    <a class="fa  opt-finish"  title="开发完成">开发完成</a>
                                @endif
