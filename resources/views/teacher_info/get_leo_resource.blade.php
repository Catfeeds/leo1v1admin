    ...
    <section class="content li-section">
        <div>
            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-3 col-md-2 {{$tag_info['tag_one']['hide']}}">
                    <div class="input-group ">
                ...
                <div class="col-xs-6 col-sm-3 col-md-2 {{$tag_info['tag_two']['hide']}} ">
                    <div class="input-group ">
                ...
                <div class="col-xs-6 col-sm-3 col-md-2 {{$tag_info['tag_three']['hide']}} ">
                    <div class="input-group ">
                ...
                <div class="col-xs-6 col-sm-3 col-md-2 {{$tag_info['tag_four']['hide']}} ">
                    <div class="input-group ">
