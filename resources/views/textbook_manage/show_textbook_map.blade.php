...
@section('content')
    ...
    <div id="container" style="width: 90%; height: 100%; padding: 10px;"></div>
    <script type="text/javascript" src="/map_test/js/jquery-1.8.3.js"></script>
    ...
    <script type="text/javascript">
        ...
        myChart.on('mapSelected', function (param){//单击省份事件
