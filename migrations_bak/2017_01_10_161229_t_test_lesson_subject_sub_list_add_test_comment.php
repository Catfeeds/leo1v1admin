...
class TTestLessonSubjectSubListAddTestComment extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::table('t_test_lesson_subject_sub_list', function( Blueprint $table)
        {
            ...
            t_field($table->integer("test_lesson_score"),"试听课总评分");
            t_field($table->string("test_lesson_advice"),"试听课建议");
            t_field($table->integer("test_lesson_comment_time"),"试听课评分时间");
