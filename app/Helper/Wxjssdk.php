...
class Wxjssdk {
    ...
    private function getJsApiTicket() {
        ...
        if ( !$data ||  $data["expire_time"]< time()) {
            ...
            if ($ticket) {
                ...
                $this->set_php_file("jsapi_ticket.php", $data);
            }
        } else {
    ...
    private function getAccessToken() {
        ...
        if (!$data || $data["expire_time"] < time()) {
            ...
            if ($access_token) {
                ...
                $this->set_php_file("access_token.php", $data);
            }
        } else {
    ...
    private function get_php_file($filename) {
        //return \App\Helper\Common::redis_get_json($filename);
        return null;
    }
    private function set_php_file($filename, $content) {
        return \App\Helper\Common::redis_set_json($filename,$content);
    }
