...
class activity_2017090101 extends  activity_base {
    ...
    protected function do_exec (  &$price,  &$present_lesson_count,  &$desc_list )   {
        ...
        if ($off_value<100) {
            //2017-0901 满课时打折(常规)
            $desc_list[]=static::gen_activity_item(1,  "$find_count_level 次课 $off_value 折" , $price,  $present_lesson_count );
        }else{
            $desc_list[]=static::gen_activity_item(0,  "" , $price,  $present_lesson_count );
        }
