...
use \App\Enums as E;
class activity_2017110901 extends  activity_config_base {

    public static $order_activity_type= E\Eorder_activity_type::V_2017110901;

    public function __construct(  $args   ) {
        parent::__construct($args);
        $this->date_range=[ "2017-11-09"  , "2017-11-09"];
        ...
        $this->user_join_time_range=["2015-01-10", "2017-09-30" ];
        $this->max_count=10;
