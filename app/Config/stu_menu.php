...
class stu_menu{
    static  public  function get_config()  {
        return [
            ...
            [ "power_id"=>20, "name"=>"学情记录",  "url"=> "/stu_manage/student_lesson_learning_record?sid={sid}"],
            [ "power_id"=>21, "name"=>"学生课表",  "url"=> "/stu_manage/student_lesson_learning_record?sid={sid}"],
