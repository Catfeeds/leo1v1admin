   ...
   static  public  function get_config()  {
        return [
            ...
            ["power_id"=>34, "name"=>"角色-教学", "list"=>[
                ...
                ["power_id"=>1, "name"=>"全职老师考勤信息",   "url"=>"/user_manage_new/get_fulltime_teacher_attendance_info_full"],
                ["power_id"=>2, "name"=>"全职老师管理",   "url"=>"/tongji_ss/tongji_fulltime_teacher_test_lesson_info"],
                ...
                ["power_id"=>7, "name"=>"全职老师转正考核申请",   "url"=>"/fulltime_teacher/full_assessment_list"],
                ["power_id"=>8, "name"=>"全职老师转正考核申请列表-总监",   "url"=>"/fulltime_teacher/fulltime_teacher_assessment_positive_info"],
                ["power_id"=>9, "name"=>"全职老师转正考核申请列表-总经理",   "url"=>"/fulltime_teacher/fulltime_teacher_assessment_positive_info_master"],
