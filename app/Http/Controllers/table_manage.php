...
class table_manage extends Controller
{
    ...
    public function query()  {
        ...
        $cmd= "http://www.atool.org/include/SqlFormatter.php/include/SqlFormatter.php?o=1&c=". base64_encode($format_sql);
        $arr= @json_decode(file_get_contents(   ),true);
        dd($arr );
        ...
        return $this->pageView(__METHOD__, $ret_info, ["col_name_list"=>$col_name_list, "format_sql"=> $new_format_sql  ] );
    }
