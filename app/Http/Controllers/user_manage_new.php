...
class user_manage_new extends Controller
{
    ...
    public function admin_group_manage(){
        ...
        $list=\App\Helper\Common_old::gen_admin_member_data_new($monthtime_flag,$start_time); // 原始数据
        // $list=\App\Helper\Common::gen_admin_member_data_new($monthtime_flag,$start_time); // 开发中
        // dd($list);
