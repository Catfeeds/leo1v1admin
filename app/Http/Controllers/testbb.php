...
class testbb extends Controller
{
    ...
    public function get_num(){
        ...
        $u= "https://open.weixin.qq.com/connect/oauth2/authorize?appid=$appid&redirect_uri=$redirect_url&response_type=code&no=$no&scope=snsapi_userinfo&state=STATE_&connect_redirect=1#wechat_redirect";
