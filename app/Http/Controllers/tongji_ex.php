...
class tongji_ex extends Controller
{
    ...
    public function threshold_detail(){
        ...
        if($type == 1){
            ...
            echo '<h3>新例子电话接通率警报详情</h3>';
            echo "<br/>";
            echo '<table border="1" width="600" align="center">';
            echo '<caption>';
            echo "警报时间:<font color='".$color_font."'>".date("Y-m-d H:i:s",$end_time)."</font>";
            echo "<br/>";
            echo "警报级别:<font color='".$color_font."'>".$color."</font>";
            echo "<br/>";
            echo "今预警线:<font color='".$color_font."'>".$threshold."%"."</font>";
            echo "<br/>";
            echo "拨打量:<font color='".$color_font."'>".$count_call."</font>";
            echo "<br/>";
            echo "拨不通:<font color='".$color_font."'>".$count_no_called."</font>";
            echo '</caption>';
            echo '</table>';
        }elseif($type == 2){
            echo '<h3>新例子电话接通率报告</h3>';
            echo "<br/>";
            echo '<table border="1" width="600" align="center">';
            echo '<caption>';
            ...
            echo "<br/>";
            echo "黄色警报:<font color='#FF8C00'".$count_y."</font>";
            echo "<br/>";
            echo "红色警报:<font color='#FF3030'>".$count_r."</font>";
            echo "<br/>";
            echo "总拨通率:".$rate."%";
            echo "<br/>";
