...
class seller_student_new2 extends Controller
{
    ...
    public function seller_test_lesson_info(){
        ...
        list($start_time,$end_time)=$this->get_in_date_range_month(0);
        $res = [];
        list($res[$adminid]['test_lesson_count'],$res[$adminid]['succ_all_count_for_month'],$res[$adminid]['fail_all_count_for_month'],$res[$adminid]['lesson_per'],$res[$adminid]['kpi'],$res[$adminid]['all_new_contract_for_month'],$res[$adminid][E\Eweek_order::V_1],$res[$adminid][E\Eweek_order::V_2],$res[$adminid][E\Eweek_order::V_3],$res[$adminid][E\Eweek_order::V_4],$dis_userid) = [0,0,0,0,0,0,[],[],[],[],[]];
