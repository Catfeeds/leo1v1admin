...
class agent extends Controller
{
    ...
    public function test_new(){
        ...
        if($self_top_info>25){//上周取消率>25%,查看当天是否有过排课申请
            ...
            $end_time = time();
            $ret_info = $this->t_test_lesson_subject_require->tongji_test_lesson_group_by_admin_revisiterid($start_time,$end_time,$grade_list=[-1] , $origin_ex="",$adminid=1214);
            ...
            dd($del_rate,$fail_all_count,$test_count);
            if($del_rate>20){
                $ret['ret'] = 3;
            }else{
                $ret['ret'] = 4;
