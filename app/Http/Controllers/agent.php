...
class agent extends Controller
{
    ...
    public function test_new(){
        $ret = $this->t_seller_student_new->get_auto_free_list_item();
        foreach($ret as $item){
            ...
            if($left_time<=0){
                ...
                if($item['phone'] == '15345287203'){
                    ...
                    // $this->t_seller_auto_free_log->row_insert([
                    //     'userid'=>$item['userid'],
    ...
    public function send_wx_msg($phone,$assign_type,$send_account,$admin_assign_time,$last_revisit_time,$last_edit_time,$first_contact_time,$first_time,$left_time_desc){
        ...
        foreach($account_arr as $account){
            $this->t_manager_info->send_template_msg(
                $account,
                $template_id,
                [
                    "first"    => "",
