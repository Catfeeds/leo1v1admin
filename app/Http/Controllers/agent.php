...
class agent extends Controller
{
    ...
    public function test_new(){
        $start_time = \App\Helper\Utils::unixtime2date($start_time=1515567600);
        $end_time   = \App\Helper\Utils::unixtime2date($end_time=1515574800);
        ...
        $tquin_map=$this->t_manager_info-> get_tquin_uid_map();
            ...
            foreach ($arr as $item ) {
                if(isset($item["Start_time"])){
                    ...
                    */
                    ...
                    $this->t_seller_student_new->sync_tq($phone ,$tq_called_flag , $call_time,$tquin);
                }
            }
        }
    }
