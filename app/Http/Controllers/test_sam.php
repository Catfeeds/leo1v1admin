        ...
        foreach ($teacher_info as $key => $value) {
           @print_r($value['uid']);
            if(isset($value['uid'])){
                ...
                "\n第一次常规审核:".$value['regular_first'].
                "\n总体完成率:".$value['per'].'%',
                "http://admin.yb1v1.com/main_page/quality_control_kpi?date_type_config=undefined&date_type=null&opt_date_type=0&start_time=".$start_time."&end_time=".$end_time."&subject=-1 ");
            }
        }
        dd($teacher_info);
