...
class test_luki extends Controller
{
    use CacheNick;
    ...
    public function test_list() {
        ...
        $ret_info=$this->t_test_luki->get_list($page_info,$grade,$start_time, $end_time);
        //dd($ret_info);
    ...
    public function sql() {
        $this->t_test_luki->get_value($id);
        $this->t_test_luki->field_get_list($id,"");
        $this->t_test_luki->row_insert($arr);
        $this->t_test_luki->row_delete($id);
        $this->t_test_luki->row_delete_2($id_value,$id_value_2);
