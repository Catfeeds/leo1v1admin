...
class teacher_level extends Controller
{
    ...
    public function send_teacher_advince_wx(){
        ...
        $teacherid = $this->get_in_int_val("teacherid");       
        $realname  = $this->t_teacher_info->get_realname($teacherid);
        $this->t_manager_info->send_wx_todo_msg_by_adminid (349,"兼职老师晋升申请","兼职老师晋升申请待处理",$realname."老师的晋升申请已提交,请尽快审核","http://admin.yb1v1.com/teacher_level/get_teacher_advance_info_list?start_time=".$start_time_str."&teacherid=".$teacherid);
        // $this->t_manager_info->send_wx_todo_msg_by_adminid (72,"兼职老师晋升申请","兼职老师晋升申请待处理",$realname."老师的晋升申请已提交,请尽快审核","http://admin.yb1v1.com/teacher_level/get_teacher_advance_info_list?start_time=".$start_time_str."&teacherid=".$teacherid);
