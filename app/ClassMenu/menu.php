        ...
        return [
            ["power_id"=>80, "name"=>"小班课",  "list"=> [
                ["power_id"=>1, "name"=>"学生管理",   "list"=>[
                    ...
                    ["power_id"=>3, "name"=>"测试",   "url"=>""],
                    ["power_id"=>4, "name"=>"教务排课明细", "url"=>""],
                    ["power_id"=>5, "name"=>"试听销售签单与否反馈", "url"=>""],
                    ["power_id"=>6, "name"=>"预分配列表", "url"=>""],
                ]],

                ["power_id"=>2, "name"=>"老师管理",   "list"=>[
                    ["power_id"=>1, "name"=>"试听排课",   "url"=>""],
                    ["power_id"=>2, "name"=>"试听排课-教务",   "url"=>""],
                    ["power_id"=>3, "name"=>"未绑定的试听课",   "url"=>""],
                    ["power_id"=>4, "name"=>"教务排课明细", "url"=>""],
                    ["power_id"=>5, "name"=>"试听销售签单与否反馈", "url"=>""],
                    ["power_id"=>6, "name"=>"预分配列表", "url"=>""],
                ]],
            ...
            ["power_id"=>81, "name"=>"小班课数据统计",  "list"=> [
                ["power_id"=>1, "name"=>"销售",   "list"=>[
                    ["power_id"=>1, "name"=>"试听排课",   "url"=>""],
                    ["power_id"=>11, "name"=>"试听排课-教务",   "url"=>""],
                    ["power_id"=>2, "name"=>"未绑定的试听课",   "url"=>""],
                    ["power_id"=>5, "name"=>"教务排课明细", "url"=>""],
                    ["power_id"=>6, "name"=>"试听销售签单与否反馈", "url"=>""],
                    ["power_id"=>7, "name"=>"预分配列表", "url"=>""],
                ]],
