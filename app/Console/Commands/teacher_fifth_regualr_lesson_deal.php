...
class teacher_fifth_regualr_lesson_deal extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:teacher_fifth_regualr_lesson_deal';
    ...
    public function handle()
    {
        ...
        foreach($ret_info as $val){
            $id = $task->t_teacher_record_list->check_lesson_record_exist($val["lessonid"],1,4);
            if($id>0){                
