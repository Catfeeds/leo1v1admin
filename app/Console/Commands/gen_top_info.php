...
class gen_top_info extends Command
{
    ...
    public function handle()
    {
        ...
        $this->task->t_tongji_seller_top_info->update_list($tongji_type,$start_time,$list);
        ...
        $this->task->t_tongji_seller_top_info->update_list($tongji_type,$start_time,$test_lesson_succ_list);
        ...
        $this->task->t_tongji_seller_top_info->update_list($tongji_type,$start_time,$order_count_list);
        ...
        $this->task->t_tongji_seller_top_info->update_list($tongji_type,$start_time,$order_percent_list);
        ...
        $this->task->t_tongji_seller_top_info->update_list($tongji_type,$start_time,$order_money_list);
        ...
        $this->task->t_tongji_seller_top_info->update_list($tongji_type,$start_time,$assign_count_list);
        ...
        $this->task->t_tongji_seller_top_info->update_list($tongji_type,$start_time,$lesson_count_list);*/
        ...
        $this->task->t_tongji_seller_top_info->update_list($tongji_type,$start_time,$order_person_count_list);
        ...
        $this->task->t_tongji_seller_top_info->update_list($tongji_type,$start_time,$test_lesson_fail_per);
