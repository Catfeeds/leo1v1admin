...
class seller_student_system_assign extends cmd_base
{
    ...
    public function get_admin_info() {
        ...
        foreach ($tmp_admin_list as $key=> $item){ //
            ...
            $end_time_item = strtotime(date('Y-m-d',time()))+3600*24;
            $start_time_item = $end_time-3600*24*8;
            $no_return_call_list = $this->task->t_seller_student_new->get_suc_no_call_list($adminid,$start_time_item,$end_time_item);
