...
class zs_lecture_info_week extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:zs_lecture_info_week';
          ...
          foreach ($teacher_info as $key => $value) {
             if($value['name'] == "总计"){
                 $task->t_manager_info->send_wx_todo_msg_by_adminid (
                    ...
                    "\n总体完成率:".$value['per'].'%',
                    "http://admin.leo1v1.com/main_page/quality_control_kpi?date_type_config=undefined&date_type=null&opt_date_type=0&start_time=".$start_date."&end_time=".$end_date."&subject=-1 ");
                }
            }
        }
