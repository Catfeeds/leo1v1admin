...
class all_type_interview_info_send_wx extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:all_type_interview_info_send_wx';
...
招聘月KPI指标:每日需面试人数:60人,面试通过18人,累计面试2200人,通过650人,考核周期6月18日到7月31号,大家加油冲锋!","http://admin.yb1v1.com/tongji_ss/teacher_interview_info_tongji?order_by_str=all_count desc&date_type=null&opt_date_type=0&start_time=".$s."&end_time=".$e); 
        ...
        foreach($arr4 as $val){
            ...
            $task->t_manager_info->send_wx_todo_msg_by_adminid ($val,"昨日文科面试信息报告","招聘月项目进度汇总","昨日面试数:".$all_day."人,当日完成率:".$all_day_per.";通过面试数:".$succ_day."人,当日完成率:".$succ_day_per.";本月文科面试数:".$all."人,通过面试数:".$succ."人,KPI完成率:".$succ_per.";
招聘月文科KPI指标:每日需面试人数:28人,面试通过8人,累计需入职280人,考核周期6月18日到7月31号,大家加油冲锋!",""); 
        ...
        foreach($arr5 as $val){
            ...
            $task->t_manager_info->send_wx_todo_msg_by_adminid ($val,"昨日数学面试信息报告","招聘月项目进度汇总","昨日面试数:".$all_day."人,当日完成率:".$all_day_per.";通过面试数:".$succ_day."人,当日完成率:".$succ_day_per.";本月数学面试数:".$all."人,通过面试数:".$succ."人,KPI完成率:".$succ_per.";
招聘月数学KPI指标:每日需面试人数:30人,面试通过9人,累计需入职315人,考核周期6月18日到7月31号,大家加油冲锋!",""); 
        ...
        foreach($arr6 as $val){
            ...
            $task->t_manager_info->send_wx_todo_msg_by_adminid ($val,"昨日综合学科面试信息报告","招聘月项目进度汇总","昨日面试数:".$all_day."人,当日完成率:".$all_day_per.";通过面试数:".$succ_day."人,当日完成率:".$succ_day_per.";本月综合学科面试数:".$all."人,通过面试数:".$succ."人,KPI完成率:".$succ_per.";
招聘月数学KPI指标:每日需面试人数:6人,面试通过2人,累计需入职120人,考核周期6月18日到7月31号,大家加油冲锋!",""); 
...
招聘月KPI指标:一周需要进行多次培训,累计需要培训通过650人,考核周期6月18日到7月31号,大家加油冲锋!",""); 
        ...
        foreach($arr3 as $val){
            $task->t_manager_info->send_wx_todo_msg_by_adminid ($val,"本月例子信息报告","招聘月项目进度汇总","昨日报名数:".$lecture_appointment_num."人,昨日试讲申请数:".$total_apply."人,录制试讲申请数:".$video_apply."人,面试试讲申请数:".$one_apply."人,累计试讲完成率:".$apply_per.";
