...
class t_lesson_info_b2 extends \App\Models\Zgen\z_t_lesson_info
{
    ...
    public function get_test_lesson_info_for_time($lesson_begin, $lesson_end){  // 试听课开课前半个小时 通知
        ...
        $sql = $this->gen_sql_new(" select m.phone , l.teacherid, l.subject, m.wx_openid as ass_openid, t.wx_openid as tea_openid, p.wx_openid as par.openid, l.lesson_start, l.lesson_end, t.nick as teacher_nick, l.userid, s.nick as stu_nick, p.nick as parent_nick from %s l "
                                  ." left join %s t on t.teacherid = l.teacherid "
                                  ." left join %s s on s.userid=l.userid "
