...
dd($ret_info);
    ...
    public function get_lesson_cancel_info_by_teacher($start_time,$end_time,$page_num,$lesson_cancel_reason_type){
        ...
        $sql = $this->gen_sql_new(" select l.teacherid,l.userid, l.lesson_count,l.lesson_cancel_reason_type from %s l".
                                  " where %s group by teacherid order by l.lesson_start desc",
                                  self::DB_TABLE_NAME,
                                  $where_arr
        );
