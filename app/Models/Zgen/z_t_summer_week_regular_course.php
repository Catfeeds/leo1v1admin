...
class z_t_summer_week_regular_course extends \App\Models\NewModel
{
    const DB_TABLE_NAME="db_weiyi.t_summer_week_regular_course";
  ...
  public function __construct()
  {
    parent::__construct();
        ...
        $this->field_table_name="db_weiyi.t_summer_week_regular_course";
  }
...
/*
  CREATE TABLE `t_summer_week_regular_course` (
  ...
  `competition_flag` int(11) NOT NULL,
  PRIMARY KEY (`teacherid`,`start_time`),
  KEY `t_summer_week_regular_course_userid_index` (`userid`)
