...
class t_test_lesson_subject_sub_list extends \App\Models\Zgen\z_t_test_lesson_subject_sub_list
{
    ...
    public function get_ass_require_test_lesson_info_change_teacher($page_info,$start_time,$end_time,$require_adminid,$master_flag,$change_teacher_reason_type){
        ...
        $sql = $this->gen_sql_new("select tr.change_teacher_reason, tr.change_teacher_reason_type, tt.require_adminid, s.nick,l.lesson_start,l.grade,l.subject,tr.origin,tt.ass_test_lesson_type,"
                                  ."t.realname,tt.textbook,s.editionid,tss.success_flag,tss.fail_reason ,l.userid,"
                                  ."tss.fail_greater_4_hour_flag,tss.test_lesson_fail_flag,l.lessonid,l.teacherid, "
                                  ." tss.ass_test_lesson_order_fail_flag ,tss.ass_test_lesson_order_fail_desc,"
    ...
    public function get_ass_require_test_lesson_info_by_kuoke($page_info,$start_time,$end_time,$require_adminid,$master_flag){
        $where_arr=[
            "l.lesson_del_flag=0",
            "m.account_role=1",
