...
class t_test_lesson_subject_require extends \App\Models\Zgen\z_t_test_lesson_subject_require
{
    ...
    public function get_plan_list_new(){
        $sql = 
            "select"
            ." ss.phone,tr.test_stugrade_str,t.subject,t.cur_require_adminid,tr.require_time"
    ...
    public function tongji_test_lesson_origin( $field_name, $start_time,$end_time,$adminid_list=[],$tmk_adminid=-1,$origin_ex=""){
        switch ( $field_name ) {
        case "origin" :
            $field_name="s.origin";
            break;
