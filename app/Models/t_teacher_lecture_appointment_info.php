...
class t_teacher_lecture_appointment_info extends \App\Models\Zgen\z_t_teacher_lecture_appointment_info
{
    ...
    public function get_recruit_name() // 根据老师名字拉取招师数据
    {
        $sql = $this->gen_sql_new("select ta.name as tname,m.name name from %s ta left join %s m on ta.accept_adminid=m.uid where ta.name in ('杨哲','熊孟秋','向文欣','辛老师','陈雪冬','张金强','周睿珊','王帅蓉','李浩博','刘佳','杨连臣','陈梦莹','仲卫懿','樊诗慧','钟淑芬','郭蕾','张萌萌','刘建敏','李烨','王波','岳文忠','李锦胜','吕瑞肇','李娟','刘惠玲','朱秀秀','韩梦馨','马宇杰','刘玮','罗召鹏','周春梅','白晓雯','邓细红','王鸿雨','任守荣','丛润泽','韩雪','樊超','张育贵','余洁','姜波','陈淑芳','付昱杰','姚晓妮','聂显山','吴姗姗','吕锋','付小谧','汪洋','张健','林守庄','刘国权','彭章裕','郭荣艳','倪老师','文美玉','鲍禾铮','秦天阳','王莹','战琼','吴勇贫','张也','谢新生','邱丽红','马刚','梁文香','李红英','徐胜','张冬晨','刘珊','孙长启','代雅丽','侯翠玲','程扶一','邹洁','娄小瑀','李东耀','邹寒','潘俊英','宋雅洁','李静','尹金萍','梁青峰','唐湘璐','郭彦均','冯雨丽','游志坪','唐婷婷','汪煜婷','陈国腾','贺毅龙','黄冬梅','李君君','宋洁','刘静静','杨爽','林双','胡雨芳','何映烁','王丹青','戢茜','董海丽','闫金香','何丽丽','李雁鸣','赵文彩','张金梁','王崇辉','张璐','郝滢','陈聪慧','齐恩薇','沈铭洋','黄蓉','宋宋','宋文怡','田楚楚','焦佳','甄宏伟','陈晓晴','金铃','杨凯伟','周心怡','殷涛','马海军','王呼雷','谢珏','阮淑怡','宋迪','叶京茹','张晓帆','刘瑶瑶','梁金凤','刘婉旭','段双双','杨彤','姜芳','齐雨欣','胡益洲','宋佳丽','刘佳文','李雪','赵敏','吴明','钟圆圆','阚鸿瑶','陈静','王娟','许一然','付娟','张和','余泳','李碧芳','杜飞','郭晓琳','李阿芳','孙丹','秦雪如','黄梦颖','田小恬','张明华','李红霞','谢晓耘','孙家琛','李英才','田红贤','陈玉梅','李晨阳','庞梅芳','王霞','李长城','潘雯','袁俊龙','何青','顾浩','李小雪','罗王勇','赵紫薇','沈云云','陈晴','王英','于梦思','王瑛','高芷若','王永兴','丁老师','魏涛','耿海玉','张红玲','李贺','刘羽婷','焦丽娜','马莉霞','董琦','李丹','胡明亮','吴伟新','郝晓莉','肖宁','朱玲婷','朱丽莎','刘玉满','苏郡','吴君','邢丽月','宋佳月','王欣','秦网','赵梅霄','黄进','苏楠','谢良玉','孙志辉','刘向钊')
 ",
                                  self::DB_TABLE_NAME,
                                  t_manager_info::DB_TABLE_NAME
        );
    ...
    public function check_tea_ref($teacherid,$teacher_ref_type){
        ...
        //     ];
        // }
        $sql = $this->gen_sql_new("select t.teacherid,t.realname,t.phone,t.create_time,"
                                  ." t2.realname as reference_name,t2.teacher_type "
                                  ." from %s t"
