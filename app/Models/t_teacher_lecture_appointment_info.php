...
class t_teacher_lecture_appointment_info extends \App\Models\Zgen\z_t_teacher_lecture_appointment_info
{
    ...
    public function get_refresh_list(){
        ...
        $sql = $this->gen_sql_new("select id,tl.phone,grade_ex,subject_ex,trans_subject_ex,trans_grade_ex,grade_start,grade_end"
                                  ." from %s tl"
                                  ." where %s"
                                  ." and exists (select 1 from %s where tl.phone=phone)"
                                  ." limit 100"
                                  ,self::DB_TABLE_NAME
                                  ,$where_arr
                                  ,t_teacher_info::DB_TABLE_NAME
