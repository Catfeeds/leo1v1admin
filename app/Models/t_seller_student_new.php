...
class t_seller_student_new extends \App\Models\Zgen\z_t_seller_student_new
{
    ...
    public function get_tmk_list( $start_time, $end_time, $seller_student_status, $page_num,$global_tq_called_flag,$grade, $subject ){
        ...
        $where_arr[]= '((s.origin_level in (1,2,3,4)) or (n.seller_student_assign_type=0 and s.origin_level=99 and n.cc_not_exist_count>0) or (n.seller_student_assign_type=0 and s.origin_level=99 and n.cc_invalid_count>2) or (n.seller_student_assign_type=1 and s.origin_level=99 and n.sys_assign_count>2)) or n.cc_invalid_count>=1 or cc_not_exist_count>=3';
    ...
    public function get_item_list_new(){
        $sql = "select ss.favorite_adminid,tr.require_id,tss.lessonid,tss.call_end_time,tr.curl_stu_request_test_lesson_time except_lesson_time,last_lesson_time, competition_call_adminid,competition_call_time,pay_time,tr.test_lesson_order_fail_desc,tr.test_lesson_order_fail_flag,seller_student_sub_status,f.flow_status stu_test_paper_flow_status,f.flowid stu_test_paper_flowid,o.price/100 order_price,s.user_agent,tr.notify_lesson_day1,tr.notify_lesson_day2,tss.confirm_time,tss.confirm_adminid,tss.fail_greater_4_hour_flag,tr.current_lessonid,tss.test_lesson_fail_flag,tss.success_flag,tss.fail_greater_4_hour_flag,tss.fail_reason,t.current_require_id,t.test_lesson_subject_id,add_time,seller_student_status,s.userid,s.nick,s.origin,ss.phone_location,ss.phone,ss.userid,ss.sub_assign_adminid_2,ss.admin_revisiterid,ss.admin_assign_time,ss.sub_assign_time_2,s.origin_assistantid,s.origin_userid,t.subject,s.grade,ss.user_desc,ss.has_pad,ss.last_revisit_time,ss.last_revisit_msg,global_tq_called_flag,tq_called_flag,next_revisit_time,l.lesson_start,l.lesson_del_flag,tr.require_time,l.teacherid,t.stu_test_paper,t.tea_download_paper_time,tr.seller_require_change_flag,tr.seller_require_change_time,accept_adminid,t.stu_request_test_lesson_time,tt.phone tea_phone,tt.user_agent tea_user_agent,l.stu_performance rate_score,a.phone ass_phone,a.nick ass_name,l.lesson_status,o.contract_status,s.type study_type,s.lesson_count_all,s.lesson_count_left,s.is_test_user,o.contract_type,o.price,o.lesson_total ,o.discount_price,o.order_status,tr.accept_flag,s.init_info_pdf_url,o.orderid,tss.parent_confirm_time,p.wx_openid parent_wx_openid,t.stu_request_lesson_time_info,t.stu_request_test_lesson_demand,ss.stu_score_info,ss.stu_character_info,t.textbook,s.editionid,tr.no_accept_reason,s.last_lesson_time,s.type stu_type,tmk_desc,tmk_student_status,sal.seller_student_assign_from_type,aga.nickname,ss.seller_student_assign_type,ss.last_edit_time,ss.first_contact_time,ss.last_succ_test_lessonid,ll.lesson_end suc_lesson_end from  db_weiyi.t_test_lesson_subject t  left join db_weiyi.t_seller_student_new ss on  ss.userid = t.userid  left join db_weiyi_admin.t_seller_student_system_assign_log sal on sal.userid = ss.userid and sal.adminid = ss.admin_revisiterid and sal.check_hold_flag = 0  left join db_weiyi.t_student_info s on ss.userid=s.userid  left join db_weiyi.t_test_lesson_subject_require tr on   t.current_require_id = tr.require_id  left join db_weiyi.t_test_lesson_subject_sub_list tss on  tr.current_lessonid = tss.lessonid  left join db_weiyi.t_lesson_info l on  tss.lessonid = l.lessonid  left join db_weiyi.t_lesson_info ll on  ll.lessonid = ss.last_succ_test_lessonid  left join db_weiyi.t_order_info o on  o.from_test_lesson_id = l.lessonid  left join db_weiyi_admin.t_flow f on ( f.flow_type=2002  and  f.from_key_int = o.orderid  ) left join db_weiyi.t_teacher_info tt on l.teacherid = tt.teacherid left join db_weiyi.t_assistant_info a on s.assistantid = a.assistantid left join db_weiyi.t_parent_info p on (p.parentid = s.parentid  and p.parentid !=0  )  left join db_weiyi.t_agent ag on ag.phone =  ss.phone  left join db_weiyi.t_agent aga on aga.id =  ag.parentid  where  admin_assign_time>=1504713600 and admin_assign_time<1520352000 and true and true and true and true and ss.admin_revisiterid=1408 and t.require_adminid=1408  order by  admin_assign_time desc  limit 0,500";
        return $this->main_get_list($sql);
    }
}
