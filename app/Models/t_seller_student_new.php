    ...
    public function get_seller_list (
        ...
        if ($userid >0 || $phone || $nick) {
            ...
            if($next_revisit_flag == 1){
                $where_arr[] = "((ss.next_revisit_time>=$start_time and ss.next_revisit_time<$end_time) or (ss.last_succ_test_lessonid>0 and ss.last_edit_time=0 and ss.last_revisit_time=0 and ll.lesson_end>1517414400))";
