...
class t_teacher_info extends \App\Models\Zgen\z_t_teacher_info
{
   ...
   public function get_no_test_lesson_teacher_lesson_info($start_time,$end_time){
    ...
    public function get_test_teacher_info($lessonid){
        ...
        $sql = $this->gen_sql_new("select t.teaching_achievement as harvest, t.parent_student_evaluate as parent_student_evaluate, l.lesson_del_flag, t.nick as tea_nick,t.gender as tea_gender,work_year,phone,"
