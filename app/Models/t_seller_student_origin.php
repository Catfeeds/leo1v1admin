...
class t_seller_student_origin extends \App\Models\Zgen\z_t_seller_student_origin
{
    ...
    public function get_origin_tongji_info_single( $field_name, $opt_date_str,$start_time,$end_time,$origin,$origin_ex,$origin_level){
        ...
        $sql = $this->gen_sql_new("select $field_name as check_value ,count(*) all_count"
                                  .",sum(n.global_tq_called_flag <>0) tq_called_count"
                                  .",sum(n.global_tq_called_flag=0 and tq.id<0 ) tq_no_call_count"
                                  .",sum(n.global_tq_called_flag=0 and n.global_seller_student_status =0  ) no_call_count"
                                  .",sum(n.admin_revisiterid >0) assigned_count"
                                  .",sum(n.global_seller_student_status = 1) invalid_count"
                                  .",sum(n.global_seller_student_status =2) no_connected_count"
                                  .",sum(n.global_seller_student_status =100) have_intention_a_count"
                                  .",sum(n.global_seller_student_status =101) have_intention_b_count"
                                  .",sum(n.global_seller_student_status =102)  have_intention_c_count"
                                  .",sum(n.global_tq_called_flag =1 ) tq_call_fail_count"
                                  .",sum(n.global_tq_called_flag =2 and n.global_seller_student_status=1) "
                                  ."tq_call_succ_invalid_count, sum( n.tmk_student_status=3 ) tmk_valid_count"
                                  ." from %s n "
                                  ." left join %s tq on n.phone = tq.phone"
