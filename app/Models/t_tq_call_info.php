...
class t_tq_call_info extends \App\Models\Zgen\z_t_tq_call_info
{
    ...
    public function get_all_info_by_cc(){
        $sql = "select m.account ,t.adminid, count(distinct(t.phone)) as total_user, sum(if((o.price>0 and o.contract_type =0 and o.contract_status <> 0),o.price,0)) as total_money,sum(if((o.price>0 and o.contract_type =0 and o.contract_status <> 0),1,0)) as total_num from db_weiyi_admin.t_tq_call_info  t
...
where t.start_time > 1509465600 and t.start_time < 1512057600 and o.order_time > 1509465600 and t.admin_role =2 group by t.adminid";
    ...
    public function get_all_info_by_cc_new(){
        ...
        where start_time > 1509465600 and start_time < 1512057600 and is_called_phone=1 group by adminid";
        return $this->main_get_list($sql,function($item){
               return $item["adminid"];
        }); 
    }
