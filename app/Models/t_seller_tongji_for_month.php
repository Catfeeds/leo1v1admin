...
class t_seller_tongji_for_month extends \App\Models\Zgen\z_t_seller_tongji_for_month
{
    ...
    public function update_funnel_date($start_time, $seller_invit_month, $has_tq_succ_invit_month, $seller_plan_invit_month, $seller_test_succ_month, $order_trans_month, $order_sign_month, $has_tq_succ_sign_month, $has_called_stu, $seller_schedule_num_month ){
        ...
        $sql = $this->gen_sql_new("  update %s s set seller_invit_month_funnel= $seller_invit_month, has_tq_succ_invit_month_funnel=$has_tq_succ_invit_month, "
                                  ...
                                  ."has_tq_succ_sign_month_funnel=$has_tq_succ_sign_month,has_called_stu_funnel=$has_called_stu, seller_schedule_num_month_funnel=$seller_schedule_num_month where %s"
                                  ,self::DB_TABLE_NAME
                                  ,$where_arr
        );
