...
use \App\Enums as E;
class t_teacher_simulate_salary_list extends \App\Models\Zgen\z_t_teacher_simulate_salary_list
{
    ...
    public function check_simulate_money_is_exists($teacherid,$add_time){
        $where_arr = [
    ...
    public function get_simulate_salary_list($start_time,$end_time,$teacher_type=-1,$teacherid=-1){
        $where_arr = [
    ...
    public function update_teacher_simulate_money($teacherid,$add_time,$money,$is_negative,$pay_time){
        $where_arr = [
            ["teacherid=%u",$teacherid,0],
            ["add_time=%u",$add_time,0],
        ];
