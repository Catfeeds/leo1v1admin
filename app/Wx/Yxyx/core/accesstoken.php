...
class AccessToken  {
    ...
    public static function getAccessToken(){
        ...
        if(\Yxyx\Core\Environment::isSae(@$_SERVER['HTTP_APPNAME_YXYX'],@$_SERVER['HTTP_ACCESSKEY_YXYX'])){
            return self::_getSae();
        }
    ...
    private static function _getAccessToken(){
        $url = 'https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid='.WECHAT_APPID_YXYX.'&secret='.WECHAT_APPSECRET_YXYX;
        ...
        $f = fopen('/tmp/teacher_access_token', 'w+');
    ...
    private static function _checkAccessToken(){
        ...
        $data = @file_get_contents('/tmp/parent_access_token');
