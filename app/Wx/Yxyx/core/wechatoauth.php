...
class WeChatOAuth extends \LaneWeChat\Core\WeChatOAuth{
    ...
    public static function getCode($redirect_uri, $state=1, $scope='snsapi_base'){
        ...
        //公众号的唯一标识
        $appid = WECHAT_APPID_YXYX;
        //授权后重定向的回调链接地址，请使用urlencode对链接进行处理
        $redirect_uri = WECHAT_URL_YXYX . $redirect_uri;
    ...
    public static function getAccessTokenAndOpenId($code){
        ...
        //构造请求微信接口的URL
        $url = 'https://api.weixin.qq.com/sns/oauth2/access_token?appid='.WECHAT_APPID_YXYX.'&secret='.WECHAT_APPSECRET_YXYX.'&code='.$code.'&grant_type='.$grant_type.''; //请求微信接口, Array(access_token, expires_in, refresh_token, openid, scope)
    ...
    public static function refreshToken($refreshToken){
        $queryUrl = 'https://api.weixin.qq.com/sns/oauth2/refresh_token?appid='.WECHAT_APPID_YXYX.'&grant_type=refresh_token&refresh_token='.$refreshToken;
        $queryAction = 'GET';
