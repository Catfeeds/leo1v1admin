...
class WechatRequest  {
    ...
    public static function text(&$request){
        ...
        }elseif($content == '双11' || $content == '11' || $content == '双十一' || $content=='活动' || $content=='双11活动' || $content=='双十一活动'){
            $tuwenList[] = array(
                'title' => '双11点赞优质教育',
                ...
                'url' => "http://wx-yxyx.leo1v1.com/wx_yxyx_common/check_is_login",
                // 'url' => 'http://admin.yb1v1.com/article_wx/leo_yxyx_int',
            );
            $item = array();
            foreach($tuwenList as $tuwen){
    ...
    public static function eventClick(&$request){
        ...
        if($eventKey == 'content') {
            ...
            $tuwenList[] = array(
                ...
                // 'url' => 'http://wx-parent-web.leo1v1.com/wx-invite-article/index.html?p_phone='.$phone.'&wx_openid='.$openid,
                'url' => 'http://wx-yxyx-web.leo1v1.com/wx_yxyx_BoutiqueContent/index.html?p_phone='.$phone.'&wx_openid='.$openid,
            );
...
绑定地址：$base_url/wx_yxyx_web/bind";
            ...
            // \App\Helper\Utils::wx_make_and_send_img($bg_url,$qr_code_url,$request,$agent,'stu');
...
绑定地址：$base_url/wx_yxyx_web/bind";
            ...
            // \App\Helper\Utils::wx_make_and_send_img($bg_url,$qr_code_url,$request,$agent,'vip');
