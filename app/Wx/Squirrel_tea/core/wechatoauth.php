 ...
 */
class WeChatOAuth extends \LaneWeChat\Core\WeChatOAuth{
    /**
     * Description: 获取CODE
    ...
    public static function getCode($redirect_uri, $state=1, $scope='snsapi_base'){
        ...
        //公众号的唯一标识
        $appid = WECHAT_APPID_TEC;
        //授权后重定向的回调链接地址，请使用urlencode对链接进行处理
        $redirect_uri = WECHAT_URL_TEC . $redirect_uri;
    ...
    public static function getAccessTokenAndOpenId($code){
        ...
        //构造请求微信接口的URL
        $url = 'https://api.weixin.qq.com/sns/oauth2/access_token?appid='.WECHAT_APPID_TEC.'&secret='.WECHAT_APPSECRET_TEC.'&code='.$code.'&grant_type='.$grant_type.'';
    ...
    public static function refreshToken($refreshToken){
        $queryUrl = 'https://api.weixin.qq.com/sns/oauth2/refresh_token?appid='.WECHAT_APPID_TEC.'&grant_type=refresh_token&refresh_token='.$refreshToken;
        $queryAction = 'GET';
