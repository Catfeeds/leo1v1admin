...
EOF;
     ...
     * @desc 加入房间
     */
    public function joinRoom($jid, $roomid, $nick)
    {
        $xml = "<presence from='$jid' to='$roomid/$nick' > <x xmlns='http://jabber.org/protocol/muc'/> </presence>";
        $this->send($xml);
    }
     ...
     * @desc 加入房间
     */
    public function joinRoom_owner($jid, $roomid, $nick)
    {
        $xml = "<presence from='$jid' to='$roomid/$nick' > <x xmlns='http://jabber.org/protocol/muc'/> <item  affiliation='owner' role='moderator'/> </presence> ";
        $this->send($xml);
    }
     ...
     * @desc 删除房间
     */
    public function delRoom($jid, $roomid )
    {
        $xml="<iq from='$jid' id='begone' to='$roomid' type='set'><query xmlns='http://jabber.org/protocol/muc#owner'><destroy /></query></iq>";
        $this->send($xml);
    }
