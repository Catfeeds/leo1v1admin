...
\usepackage[colorlinks,unicode,urlcolor=blue,linkcolor=blue,
        pdftitle=学员-周子合同,pdfauthor=ProcessOne,pdfsubject=leodeu,pdfkeywords=leoedu, pdfpagelabels=false]{hyperref}

% == 设置页面
\usepackage[top=4cm,left=3cm,right=3cm,bottom=3cm]{geometry}
\geometry{papersize={21cm,29.7cm}}
%--------------------------------结束-------------------------------------
%-------------------------------导言--------------------------------------
\newsavebox{\headpic}
\sbox{\headpic}{\includegraphics[height=1.05cm]{./1.png}} %设置页眉logo页眉
...
\SetWatermarkText{\includegraphics{./b1.png}}
\usepackage{fontspec}
